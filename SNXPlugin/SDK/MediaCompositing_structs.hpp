...
public:
	...
	uint8                                         Pad_1271[0x3];                                     // 0x0055(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(FMovieSceneMediaPlayerPropertySectionTemplate) == 0x000058, "Wrong size on FMovieSceneMediaPlayerPropertySectionTemplate");
static_assert(offsetof(FMovieSceneMediaPlayerPropertySectionTemplate, MediaSource) == 0x000048, "Member 'FMovieSceneMediaPlayerPropertySectionTemplate::MediaSource' has a wrong offset!");
static_assert(offsetof(FMovieSceneMediaPlayerPropertySectionTemplate, SectionStartFrame) == 0x000050, "Member 'FMovieSceneMediaPlayerPropertySectionTemplate::SectionStartFrame' has a wrong offset!");
static_assert(offsetof(FMovieSceneMediaPlayerPropertySectionTemplate, bLoop) == 0x000054, "Member 'FMovieSceneMediaPlayerPropertySectionTemplate::bLoop' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1272[0x3];                                     // 0x0029(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
