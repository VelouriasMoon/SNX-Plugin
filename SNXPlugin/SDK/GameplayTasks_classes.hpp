...
{
public:
	uint8                                         Pad_2D8A[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2D8B[0x2];                                     // 0x0038(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2D8C[0x25];                                    // 0x003B(0x0025)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2D91[0x18];                                    // 0x0088(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2D94[0x10];                                    // 0x0088(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2D95[0x8];                                     // 0x0078(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2D97[0x3];                                     // 0x002D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2D98[0x7];                                     // 0x0031(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2D99[0xC];                                     // 0x00C0(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         BitPad_4B : 1;                                     // 0x00CC(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	...
	uint8                                         Pad_2D9A[0x3];                                     // 0x00CD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UGameplayTask*>                  SimulatedTasks;                                    // 0x00D0(0x0010)(Net, ZeroConstructor, RepNotify, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UGameplayTask*>                  TaskPriorityQueue;                                 // 0x00E0(0x0010)(ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2D9B[0x10];                                    // 0x00F0(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UGameplayTask*>                  TickingTasks;                                      // 0x0100(0x0010)(ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UGameplayTask*>                  KnownTasks;                                        // 0x0110(0x0010)(ZeroConstructor, Transient, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
