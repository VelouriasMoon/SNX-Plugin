...
void UMovieSceneSequencePlayer::SeekPlaybackPosition(float NewPosition)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MovieSceneSequencePlayer", "SeekPlaybackPosition");

	Params::MovieSceneSequencePlayer_SeekPlaybackPosition Parms{};
...
void UMovieSceneSequencePlayer::SetPlaybackPauseAtEnd(bool Enable)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MovieSceneSequencePlayer", "SetPlaybackPauseAtEnd");

	Params::MovieSceneSequencePlayer_SetPlaybackPauseAtEnd Parms{};
...
// Parameters:
// class FString                           InLabel                                                (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FFrameTime                       MarkTime                                               (Parm, OutParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UMovieSceneSequencePlayer::GetMarkedFrameByLabel(const class FString& InLabel, struct FFrameTime* MarkTime) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MovieSceneSequencePlayer", "GetMarkedFrameByLabel");

	Params::MovieSceneSequencePlayer_GetMarkedFrameByLabel Parms{};
	...
	if (MarkTime != nullptr)
		*MarkTime = std::move(Parms.MarkTime);
