...
public:
	...
	uint8                                         Pad_1819[0x5];                                     // 0x002B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_181A[0x6];                                     // 0x0052(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_181B[0x7];                                     // 0x0069(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UUdpMessagingSettings, bAutoRepair) == 0x000029, "Member 'UUdpMessagingSettings::bAutoRepair' has a wrong offset!");
static_assert(offsetof(UUdpMessagingSettings, bStopServiceWhenAppDeactivates) == 0x00002A, "Member 'UUdpMessagingSettings::bStopServiceWhenAppDeactivates' has a wrong offset!");
...
static_assert(offsetof(UUdpMessagingSettings, MessageFormat) == 0x000050, "Member 'UUdpMessagingSettings::MessageFormat' has a wrong offset!");
static_assert(offsetof(UUdpMessagingSettings, MulticastTimeToLive) == 0x000051, "Member 'UUdpMessagingSettings::MulticastTimeToLive' has a wrong offset!");
