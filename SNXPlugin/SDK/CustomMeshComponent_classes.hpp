...
{
public:
	uint8                                         Pad_1825[0x10];                                    // 0x0430(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UCustomMeshComponent) == 0x000440, "Wrong size on UCustomMeshComponent");
