...
public:
	...
	uint8                                         Pad_15DD[0x7];                                     // 0x0281(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UAnimSharingStateInstance, AnimationToPlay) == 0x000270, "Member 'UAnimSharingStateInstance::AnimationToPlay' has a wrong offset!");
static_assert(offsetof(UAnimSharingStateInstance, PermutationTimeOffset) == 0x000278, "Member 'UAnimSharingStateInstance::PermutationTimeOffset' has a wrong offset!");
static_assert(offsetof(UAnimSharingStateInstance, PlayRate) == 0x00027C, "Member 'UAnimSharingStateInstance::PlayRate' has a wrong offset!");
static_assert(offsetof(UAnimSharingStateInstance, bStateBool) == 0x000280, "Member 'UAnimSharingStateInstance::bStateBool' has a wrong offset!");
static_assert(offsetof(UAnimSharingStateInstance, Instance) == 0x000288, "Member 'UAnimSharingStateInstance::Instance' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_15DE[0xB];                                     // 0x0285(0x000B)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAnimSharingTransitionInstance) == 0x000290, "Wrong size on UAnimSharingTransitionInstance");
static_assert(offsetof(UAnimSharingTransitionInstance, FromComponent) == 0x000270, "Member 'UAnimSharingTransitionInstance::FromComponent' has a wrong offset!");
static_assert(offsetof(UAnimSharingTransitionInstance, ToComponent) == 0x000278, "Member 'UAnimSharingTransitionInstance::ToComponent' has a wrong offset!");
static_assert(offsetof(UAnimSharingTransitionInstance, BlendTime) == 0x000280, "Member 'UAnimSharingTransitionInstance::BlendTime' has a wrong offset!");
static_assert(offsetof(UAnimSharingTransitionInstance, bBlendBool) == 0x000284, "Member 'UAnimSharingTransitionInstance::bBlendBool' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_15DF[0xB];                                     // 0x0285(0x000B)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAnimSharingAdditiveInstance) == 0x000290, "Wrong size on UAnimSharingAdditiveInstance");
static_assert(offsetof(UAnimSharingAdditiveInstance, BaseComponent) == 0x000270, "Member 'UAnimSharingAdditiveInstance::BaseComponent' has a wrong offset!");
static_assert(offsetof(UAnimSharingAdditiveInstance, AdditiveAnimation) == 0x000278, "Member 'UAnimSharingAdditiveInstance::AdditiveAnimation' has a wrong offset!");
static_assert(offsetof(UAnimSharingAdditiveInstance, Alpha) == 0x000280, "Member 'UAnimSharingAdditiveInstance::Alpha' has a wrong offset!");
static_assert(offsetof(UAnimSharingAdditiveInstance, bStateBool) == 0x000284, "Member 'UAnimSharingAdditiveInstance::bStateBool' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_15E0[0x70];                                    // 0x0038(0x0070)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_15E1[0x38];                                    // 0x00B0(0x0038)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_15E2[0x10];                                    // 0x00F8(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_15E3[0x20];                                    // 0x0118(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_15E4[0x48];                                    // 0x0048(0x0048)(Fixing Struct Size After Last Property [ Dumper-7 ])
