...
{
public:
	uint8                                         Pad_2E02[0x750];                                   // 0x0028(0x0750)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAssetRegistryImpl) == 0x000778, "Wrong size on UAssetRegistryImpl");
