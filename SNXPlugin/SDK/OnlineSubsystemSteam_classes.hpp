...
{
public:
	uint8                                         Pad_FF5[0x8];                                      // 0x07B8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USteamNetDriver) == 0x0007C0, "Wrong size on USteamNetDriver");
...
public:
	...
	uint8                                         Pad_FF6[0x7];                                      // 0x1AD1(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USteamNetConnection) == 0x001AD8, "Wrong size on USteamNetConnection");
static_assert(offsetof(USteamNetConnection, bIsPassthrough) == 0x001AD0, "Member 'USteamNetConnection::bIsPassthrough' has a wrong offset!");
