...
{
public:
	uint8                                         Pad_1842[0x8];                                     // 0x0148(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bDeprecatedSpringOffsetMode : 1;                   // 0x0150(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bReverseAsBrake : 1;                               // 0x0150(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bUseRVOAvoidance : 1;                              // 0x0150(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bRawHandbrakeInput : 1;                            // 0x0150(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bRawGearUpInput : 1;                               // 0x0150(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bRawGearDownInput : 1;                             // 0x0150(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         BitPad_43 : 2;                                     // 0x0050(0x0001)(Fixing Bit-Field Size For New Byte [ Dumper-7 ])
	uint8                                         Pad_1843[0x3];                                     // 0x0151(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bWasAvoidanceUpdated : 1;                          // 0x0154(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_1844[0x3];                                     // 0x0155(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1845[0x4];                                     // 0x015C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	int32                                         LowForwardSpeedSubStepCount;                       // 0x01AC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         HighForwardSpeedSubStepCount;                      // 0x01B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1846[0x4];                                     // 0x01B4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1847[0x18];                                    // 0x01C8(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	int32                                         AvoidanceUID;                                      // 0x01F4(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_1848[0x4];                                     // 0x0228(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1849[0x24];                                    // 0x0274(0x0024)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UWheeledVehicleMovementComponent) == 0x0002A0, "Wrong size on UWheeledVehicleMovementComponent");
static_assert(offsetof(UWheeledVehicleMovementComponent, Mass) == 0x000158, "Member 'UWheeledVehicleMovementComponent::Mass' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, WheelSetups) == 0x000160, "Member 'UWheeledVehicleMovementComponent::WheelSetups' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, DragCoefficient) == 0x000170, "Member 'UWheeledVehicleMovementComponent::DragCoefficient' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, ChassisWidth) == 0x000174, "Member 'UWheeledVehicleMovementComponent::ChassisWidth' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, ChassisHeight) == 0x000178, "Member 'UWheeledVehicleMovementComponent::ChassisHeight' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, DragArea) == 0x00017C, "Member 'UWheeledVehicleMovementComponent::DragArea' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, EstimatedMaxEngineSpeed) == 0x000180, "Member 'UWheeledVehicleMovementComponent::EstimatedMaxEngineSpeed' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, MaxEngineRPM) == 0x000184, "Member 'UWheeledVehicleMovementComponent::MaxEngineRPM' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, DebugDragMagnitude) == 0x000188, "Member 'UWheeledVehicleMovementComponent::DebugDragMagnitude' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, InertiaTensorScale) == 0x00018C, "Member 'UWheeledVehicleMovementComponent::InertiaTensorScale' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, MinNormalizedTireLoad) == 0x000198, "Member 'UWheeledVehicleMovementComponent::MinNormalizedTireLoad' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, MinNormalizedTireLoadFiltered) == 0x00019C, "Member 'UWheeledVehicleMovementComponent::MinNormalizedTireLoadFiltered' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, MaxNormalizedTireLoad) == 0x0001A0, "Member 'UWheeledVehicleMovementComponent::MaxNormalizedTireLoad' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, MaxNormalizedTireLoadFiltered) == 0x0001A4, "Member 'UWheeledVehicleMovementComponent::MaxNormalizedTireLoadFiltered' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, ThresholdLongitudinalSpeed) == 0x0001A8, "Member 'UWheeledVehicleMovementComponent::ThresholdLongitudinalSpeed' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, LowForwardSpeedSubStepCount) == 0x0001AC, "Member 'UWheeledVehicleMovementComponent::LowForwardSpeedSubStepCount' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, HighForwardSpeedSubStepCount) == 0x0001B0, "Member 'UWheeledVehicleMovementComponent::HighForwardSpeedSubStepCount' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, Wheels) == 0x0001B8, "Member 'UWheeledVehicleMovementComponent::Wheels' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, RVOAvoidanceRadius) == 0x0001E0, "Member 'UWheeledVehicleMovementComponent::RVOAvoidanceRadius' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, RVOAvoidanceHeight) == 0x0001E4, "Member 'UWheeledVehicleMovementComponent::RVOAvoidanceHeight' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, AvoidanceConsiderationRadius) == 0x0001E8, "Member 'UWheeledVehicleMovementComponent::AvoidanceConsiderationRadius' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, RVOSteeringStep) == 0x0001EC, "Member 'UWheeledVehicleMovementComponent::RVOSteeringStep' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, RVOThrottleStep) == 0x0001F0, "Member 'UWheeledVehicleMovementComponent::RVOThrottleStep' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, AvoidanceUID) == 0x0001F4, "Member 'UWheeledVehicleMovementComponent::AvoidanceUID' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, AvoidanceGroup) == 0x0001F8, "Member 'UWheeledVehicleMovementComponent::AvoidanceGroup' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, GroupsToAvoid) == 0x0001FC, "Member 'UWheeledVehicleMovementComponent::GroupsToAvoid' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, GroupsToIgnore) == 0x000200, "Member 'UWheeledVehicleMovementComponent::GroupsToIgnore' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, AvoidanceWeight) == 0x000204, "Member 'UWheeledVehicleMovementComponent::AvoidanceWeight' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, PendingLaunchVelocity) == 0x000208, "Member 'UWheeledVehicleMovementComponent::PendingLaunchVelocity' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, ReplicatedState) == 0x000214, "Member 'UWheeledVehicleMovementComponent::ReplicatedState' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, RawSteeringInput) == 0x00022C, "Member 'UWheeledVehicleMovementComponent::RawSteeringInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, RawThrottleInput) == 0x000230, "Member 'UWheeledVehicleMovementComponent::RawThrottleInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, RawBrakeInput) == 0x000234, "Member 'UWheeledVehicleMovementComponent::RawBrakeInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, SteeringInput) == 0x000238, "Member 'UWheeledVehicleMovementComponent::SteeringInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, ThrottleInput) == 0x00023C, "Member 'UWheeledVehicleMovementComponent::ThrottleInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, BrakeInput) == 0x000240, "Member 'UWheeledVehicleMovementComponent::BrakeInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, HandbrakeInput) == 0x000244, "Member 'UWheeledVehicleMovementComponent::HandbrakeInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, IdleBrakeInput) == 0x000248, "Member 'UWheeledVehicleMovementComponent::IdleBrakeInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, StopThreshold) == 0x00024C, "Member 'UWheeledVehicleMovementComponent::StopThreshold' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, WrongDirectionThreshold) == 0x000250, "Member 'UWheeledVehicleMovementComponent::WrongDirectionThreshold' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, ThrottleInputRate) == 0x000254, "Member 'UWheeledVehicleMovementComponent::ThrottleInputRate' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, BrakeInputRate) == 0x00025C, "Member 'UWheeledVehicleMovementComponent::BrakeInputRate' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, HandbrakeInputRate) == 0x000264, "Member 'UWheeledVehicleMovementComponent::HandbrakeInputRate' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, SteeringInputRate) == 0x00026C, "Member 'UWheeledVehicleMovementComponent::SteeringInputRate' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, OverrideController) == 0x000298, "Member 'UWheeledVehicleMovementComponent::OverrideController' has a wrong offset!");
...
static_assert(sizeof(USimpleWheeledVehicleMovementComponent) == 0x0002A0, "Wrong size on USimpleWheeledVehicleMovementComponent");
...
public:
	...
	uint8                                         Pad_184B[0x4];                                     // 0x0034(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_184C[0x8];                                     // 0x0048(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_184D[0x700];                                   // 0x0270(0x0700)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_184E[0x8];                                     // 0x0978(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_184F[0x2];                                     // 0x0032(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1850[0x3];                                     // 0x0055(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1851[0x3];                                     // 0x0089(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1852[0x4];                                     // 0x0094(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1853[0x4];                                     // 0x00B0(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1854[0xC];                                     // 0x00E4(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AWheeledVehicle) == 0x0002A0, "Wrong size on AWheeledVehicle");
static_assert(offsetof(AWheeledVehicle, Mesh) == 0x000290, "Member 'AWheeledVehicle::Mesh' has a wrong offset!");
static_assert(offsetof(AWheeledVehicle, VehicleMovement) == 0x000298, "Member 'AWheeledVehicle::VehicleMovement' has a wrong offset!");
...
static_assert(sizeof(UWheeledVehicleMovementComponent4W) == 0x000418, "Wrong size on UWheeledVehicleMovementComponent4W");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, EngineSetup) == 0x0002A0, "Member 'UWheeledVehicleMovementComponent4W::EngineSetup' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, DifferentialSetup) == 0x000340, "Member 'UWheeledVehicleMovementComponent4W::DifferentialSetup' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, AckermannAccuracy) == 0x00035C, "Member 'UWheeledVehicleMovementComponent4W::AckermannAccuracy' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, TransmissionSetup) == 0x000360, "Member 'UWheeledVehicleMovementComponent4W::TransmissionSetup' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, SteeringCurve) == 0x000390, "Member 'UWheeledVehicleMovementComponent4W::SteeringCurve' has a wrong offset!");
