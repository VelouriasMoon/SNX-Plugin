...
// (Final, Native, Private, BlueprintCallable)
// Parameters:
// int32                                   InPauseFlag                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UUserWidget::SetWidgetPauseFlag(int32 InPauseFlag)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UserWidget", "SetWidgetPauseFlag");

	Params::UserWidget_SetWidgetPauseFlag Parms{};
...
void UUserWidget::GetWidgetPauseFlag(int32* ReturnValue) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UserWidget", "GetWidgetPauseFlag");

	Params::UserWidget_GetWidgetPauseFlag Parms{};
