...
namespace Offsets
{
	constexpr int32 GObjects          = 0x04FBD4A0;
	constexpr int32 AppendString      = 0x0156F050;
	constexpr int32 GNames            = 0x04F91600;
	constexpr int32 GWorld            = 0x051061D0;
	constexpr int32 ProcessEvent      = 0x0173DB90;
