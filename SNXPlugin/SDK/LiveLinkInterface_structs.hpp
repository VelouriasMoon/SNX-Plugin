...
{
public:
	uint8                                         Pad_1176[0x18];                                    // 0x0000(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_1177[0x8];                                     // 0x0000(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_1178[0x10];                                    // 0x0008(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_1179[0x20];                                    // 0x0000(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_117A[0x160];                                   // 0x0000(0x0160)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_117B[0x4];                                     // 0x006C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_117C[0x20];                                    // 0x0080(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_117D[0x2];                                     // 0x001E(0x0002)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_117E[0xB];                                     // 0x00E5(0x000B)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_117F[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1180[0x7];                                     // 0x0019(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_1181[0xC];                                     // 0x00F4(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_1183[0x7];                                     // 0x0031(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_1184[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1186[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1187[0x2];                                     // 0x0022(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1188[0x3];                                     // 0x002D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1189[0x7];                                     // 0x0049(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(FLiveLinkSourceBufferManagementSettings) == 0x000050, "Wrong size on FLiveLinkSourceBufferManagementSettings");
...
static_assert(offsetof(FLiveLinkSourceBufferManagementSettings, TimecodeFrameRate) == 0x000018, "Member 'FLiveLinkSourceBufferManagementSettings::TimecodeFrameRate' has a wrong offset!");
...
static_assert(offsetof(FLiveLinkSourceBufferManagementSettings, bUseTimecodeSmoothLatest) == 0x000021, "Member 'FLiveLinkSourceBufferManagementSettings::bUseTimecodeSmoothLatest' has a wrong offset!");
static_assert(offsetof(FLiveLinkSourceBufferManagementSettings, SourceTimecodeFrameRate) == 0x000024, "Member 'FLiveLinkSourceBufferManagementSettings::SourceTimecodeFrameRate' has a wrong offset!");
static_assert(offsetof(FLiveLinkSourceBufferManagementSettings, bValidTimecodeFrameEnabled) == 0x00002C, "Member 'FLiveLinkSourceBufferManagementSettings::bValidTimecodeFrameEnabled' has a wrong offset!");
static_assert(offsetof(FLiveLinkSourceBufferManagementSettings, ValidTimecodeFrame) == 0x000030, "Member 'FLiveLinkSourceBufferManagementSettings::ValidTimecodeFrame' has a wrong offset!");
static_assert(offsetof(FLiveLinkSourceBufferManagementSettings, TimecodeFrameOffset) == 0x000034, "Member 'FLiveLinkSourceBufferManagementSettings::TimecodeFrameOffset' has a wrong offset!");
static_assert(offsetof(FLiveLinkSourceBufferManagementSettings, TimecodeClockOffset) == 0x000038, "Member 'FLiveLinkSourceBufferManagementSettings::TimecodeClockOffset' has a wrong offset!");
static_assert(offsetof(FLiveLinkSourceBufferManagementSettings, LatestOffset) == 0x000040, "Member 'FLiveLinkSourceBufferManagementSettings::LatestOffset' has a wrong offset!");
static_assert(offsetof(FLiveLinkSourceBufferManagementSettings, MaxNumberOfFrameToBuffered) == 0x000044, "Member 'FLiveLinkSourceBufferManagementSettings::MaxNumberOfFrameToBuffered' has a wrong offset!");
static_assert(offsetof(FLiveLinkSourceBufferManagementSettings, bKeepAtLeastOneFrame) == 0x000048, "Member 'FLiveLinkSourceBufferManagementSettings::bKeepAtLeastOneFrame' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_118A[0x8];                                     // 0x0018(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
